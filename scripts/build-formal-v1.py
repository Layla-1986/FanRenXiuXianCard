...
*{box-sizing:border-box}html,body{margin:0;width:480px;height:270px;overflow:hidden;background:#07130f}.pages{position:relative;width:480px;height:270px;--ward-gold:#d5b564;--moon-white:#e7e7d6}iframe{display:block;width:480px;height:270px;border:0}iframe[hidden]{display:none}.drag-surface{position:absolute;inset:0;z-index:10}.pages>.page-switch,.pages>.seal-lock{position:absolute;z-index:20;-webkit-app-region:no-drag}.pages>.page-switch{right:49px;top:15px}.pages>.seal-lock{right:14px;top:13px}.page-switch,.pages>.seal-lock{cursor:pointer}
