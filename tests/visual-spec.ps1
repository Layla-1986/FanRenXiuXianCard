...
Assert-True ($collector.Contains("@('Model Quota', 'Model Credits', 'Gemini Models', 'Claude and GPT models')")) 'Antigravity collector must preserve exact quota-heading anchors when Chromium exposes headings separately'
