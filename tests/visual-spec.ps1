...
Assert-True ($css.Contains('left: 18px')) 'Quota percentage must align with the formation eye'
Assert-True ($css.Contains('top: 140px')) 'Quota percentage must align vertically with the formation eye'
