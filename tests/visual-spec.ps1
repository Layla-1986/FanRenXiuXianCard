...
Assert-True ($css.Contains('font-size: 42px')) 'Quota percentage must fit entirely inside the formation eye'
Assert-True ($css.Contains('--formation-eye-x: 98px')) 'Formation eye must expose one shared horizontal center'
Assert-True ($css.Contains('--formation-eye-y: 168px')) 'Formation eye must expose one shared vertical center'
...
Assert-True ($css.Contains('top: calc(var(--formation-eye-y) - 46px)')) 'Quota percentage must derive its vertical position from the formation eye center'
